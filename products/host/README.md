...
All installers include the Bun runtime, Computer helper source, and PDF standard-font data. Users
do not need Node.js or Bun. Computer control still requires the platform-specific Python runtime,
which is installed explicitly with `computer install`.
