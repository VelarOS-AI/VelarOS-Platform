...
export type ProjectTransactionCommand = 'amend' | 'validate' | 'apply' | 'rollback' | 'discard'
...
export const ProjectTransactionCommandTable = Object.freeze({
  ...
  Record<ProjectTransactionCommand, readonly ProjectTransactionStatus[]>
>)
...
function allows(command: ProjectTransactionCommand, status: ProjectTransactionStatus): boolean {
  return (ProjectTransactionCommandTable[command] as readonly ProjectTransactionStatus[]).includes(
    status,
  )
}
...
export class TransactionStateMachine {
  ...
  public beginApply(
    transaction: StoredTransaction,
  ): Extract<ProjectTransactionExecution, { command: 'apply' }> {
  ...
  public beginRollback(
    transaction: StoredTransaction,
  ): Extract<ProjectTransactionExecution, { command: 'rollback' }> {
  ...
  public executionStatus(
    execution: ProjectTransactionExecution,
  ): ProjectTransactionExecutionStatus {
