...
export const ProjectHiddenDirectoryAllowlist: string[] = ['.xcodeproj', '.xcworkspace']

const ProjectExcludedDirectoryNameSet = new Set(ProjectExcludedDirectoryNames)
const ProjectModelRestrictedDirectoryNameSet = new Set(ProjectModelRestrictedDirectoryNames)
const ProjectDiscoverySkippedDirectoryNameSet = new Set(ProjectDiscoverySkippedDirectoryNames)
const ProjectHiddenDirectoryAllowlistSet = new Set(ProjectHiddenDirectoryAllowlist)
...
export function shouldSkipProjectDiscoveryDirectory(
  ...
  if (name.startsWith('.') && !ProjectHiddenDirectoryAllowlistSet.has(name)) return true
