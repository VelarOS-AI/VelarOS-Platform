...
const ToolPresentationByName: Readonly<Record<string, ToolPresentationMetadata>> = {
  ...
  'project:file': metadata('file-change', ['file-change'], true),
  'project:edit': metadata('file-change', ['file-change'], true),
  'project:change': metadata('file-change', ['file-change'], true),
  ...
  'project:code': metadata('search', ['search']),
  'project:code-analysis': metadata('search', ['search']),
