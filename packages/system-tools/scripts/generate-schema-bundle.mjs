...
// 供 check:schemas 等下游以「dist 产物」而非「源码可达性」消费(拆仓后随包分发本产物,
// 消费方只读产物,不再 import 本包 src 深路径)。
//
...
import { systemProjectTools, systemTools } from '../src/Collection'
...
const artifact = {
  schemaVersion: 1,
  package: '@velaros-ai/system-tools',
  generatedFrom: 'src/Collection',
  collections: [
    buildCollectionArtifact('system-tools', systemTools),
    buildCollectionArtifact('system-project-tools', systemProjectTools),
  ],
}
