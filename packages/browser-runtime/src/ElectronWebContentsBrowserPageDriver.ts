...
import type { BrowserEmulationOptions, BrowserMouseButton, BrowserNetworkControlOptions, BrowserNetworkRequestDetailsOptions, BrowserNetworkResponseBodyOptions, BrowserPageDiagnosticEntry, BrowserViewportOptions } from '@velaros-ai/browser-core'
import {
  applyCdpEmulation,
