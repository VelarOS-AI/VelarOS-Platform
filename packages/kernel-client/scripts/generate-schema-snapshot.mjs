...
import { KernelProtocolVersion } from '../src/protocol/handshake.ts'
import { KernelProtocolWireSchemas } from '../src/protocol/schema-snapshot.ts'
...
const snapshot = {
  package: '@velaros-ai/kernel-client',
