...
import type { BrowserClickCoordinatesOptions, BrowserClickCoordinatesResult, BrowserMoveMouseResult, BrowserPageNavigationOptions, BrowserPageNavigationResult, BrowserPageScrollOptions, BrowserPageScrollResult, BrowserPageWaitOptions, BrowserPageWaitResult, BrowserPageZoomOptions, BrowserPageZoomResult, BrowserPressKeyOptions, BrowserPressKeyResult, BrowserTargetActionOptions, BrowserTypeTextResult, BrowserViewportResult, BrowserWaitForSelectorResult } from '@velaros-ai/browser-core'
