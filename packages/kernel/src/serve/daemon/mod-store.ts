...
import type { KernelModPackKind } from '@velaros-ai/kernel/contracts/protocol'
...
export class KernelModStore {
  ...
  public enable(id: string): boolean {
    ...
    if (isUndefined(pack)) return false
