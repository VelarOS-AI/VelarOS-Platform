...
import { KernelProtocolVersion } from '../src/kernel/protocol/handshake.ts'
import { KernelProtocolWireSchemas } from '../src/kernel/protocol/schema-snapshot.ts'
